...
IF OBJECT_ID('dbo.InfoContacts', 'U') IS NOT NULL DROP TABLE dbo.InfoContacts;
IF OBJECT_ID('dbo.Contacts', 'U') IS NOT NULL DROP TABLE dbo.Contacts;
IF OBJECT_ID('dbo.Societes', 'U') IS NOT NULL DROP TABLE dbo.Societes;
GO

-- Création de la table Societes
SET ANSI_NULLS ON
GO
...
-- Création de la table InfoContacts
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
-- Insertion des données dans Societes
SET IDENTITY_INSERT [dbo].[Societes] ON 
GO
INSERT [dbo].[Societes] ([Id], [Nom], [Adresse], [Adresse2], [CodePostal], [Ville], [TelStandard])
VALUES (1, N'Société A', N'Adresse 1', N'Adresse 2', N'75001', N'Paris', N'0102030405')
GO
INSERT [dbo].[Societes] ([Id], [Nom], [Adresse], [Adresse2], [CodePostal], [Ville], [TelStandard])
VALUES (2, N'Société B', N'Adresse 3', N'Adresse 4', N'69001', N'Lyon', N'0607080910')
GO
...
GO
INSERT [dbo].[Contacts] ([Id], [SocieteId], [Civilite], [Nom], [Prenom], [Fonction])
VALUES (1, 1, N'M.', N'Dupont', N'Jean', N'Directeur')
GO
INSERT [dbo].[Contacts] ([Id], [SocieteId], [Civilite], [Nom], [Prenom], [Fonction])
VALUES (2, 1, N'Mme', N'Martin', N'Sophie', N'Responsable RH')
GO
INSERT [dbo].[Contacts] ([Id], [SocieteId], [Civilite], [Nom], [Prenom], [Fonction])
VALUES (3, 2, N'M.', N'Durand', N'Pierre', N'Commercial')
GO
INSERT [dbo].[Contacts] ([Id], [SocieteId], [Civilite], [Nom], [Prenom], [Fonction])
VALUES (4, 2, N'Mme', N'Leroy', N'Marie', N'Comptable')
GO
SET IDENTITY_INSERT [dbo].[Contacts] OFF
GO

-- Insertion des données dans InfoContacts
